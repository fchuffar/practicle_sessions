...
projectName <- "non_polyA_signature"               # name of the project
author <- "Céline Mandier, Florent Chuffart"         # author of the statistical analysis/report

targetFile <- "design.txt"                           # path to the design/target file
rawDir <- "raw_counts"                                # path to the directory containing raw counts files
featuresToRemove <- c("alignment_not_unique",        # names of the features to be removed
                      "ambiguous", "no_feature",     # (specific HTSeq-count information and rRNA for example)
                      "not_aligned", "too_low_aQual")# NULL if no feature to remove

varInt <- "factor"                                   # factor of interest
condRef <- "TOTAL"                                   # reference biological condition
